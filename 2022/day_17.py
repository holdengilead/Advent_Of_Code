...
def main():
    t = Tunnel("./day_17_input_test.txt", 2022)
    print(t.highest_point)  # 3068

    t = Tunnel("./day_17_input_test.txt", 1_000_000_000_000)
    print(t.highest_point)  # 1514285714288

    t = Tunnel("./day_17_input.txt", 2022)
    print(t.highest_point)  # 3151

    t = Tunnel("./day_17_input.txt", 1_000_000_000_000)
